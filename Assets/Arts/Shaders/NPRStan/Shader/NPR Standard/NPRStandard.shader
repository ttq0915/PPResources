Shader "NPRStandard"
{
    Properties
    {
        ...
        [Sub(Outline._OUTLINE)] [HDR]_OutlineColor ("Outline Color", Color) = (0,0,0,0)
        ...
        [Sub(DissolveSetting)] _DissolveThreshold ("Dissolve Threshold", Range(-0.05, 1.05)) = 0
        [Sub(DissolveSetting)][HDR] _DissolveColor("DissolveColor",Color) = (1,1,1,1)
        [Sub(DissolveSetting)] _EdgeWidth("EdgeWidth",Range(0,1)) = 0
        // RenderSetting    
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local _fragment _ALPHATEST_ON
